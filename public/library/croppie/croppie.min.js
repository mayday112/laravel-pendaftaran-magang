!(function (e, t) {
            ...
            (i.prototype.catch = function (e) {
                ...
                (i.all = function () {
                    var e = Array.prototype.slice.call(
                        1 === arguments.length && u(arguments[0])
                            ? arguments[0]
                            : arguments
                    );
    ...
    function y(e) {
        return e.exifdata && e.exifdata.Orientation
            ? m(e.exifdata.Orientation)
            : 1;
    }
    function b(e, t, i) {
        var n = t.width,
    ...
    function x() {
        ...
        (this.options.useCanvas =
            this.options.enableOrientation || C.call(this)),
            (this.data = {}),
            (this.elements = {}),
            ...
            this.options.customClass &&
                p(this.element, this.options.customClass),
            function () {
                var e,
                    n,
                    o,
                ...
                function d(t) {
                    if (
                        ...
                        if (
                            ((l = !0), (e = t.pageX), (n = t.pageY), t.touches)
                        ) {
                            var o = t.touches[0];
                            (e = o.pageX), (n = o.pageY);
                        }
                ...
                s.elements.overlay.addEventListener("mousedown", d),
                    s.elements.viewport.addEventListener(
                        "keydown",
                        function (e) {
                            var n = 37,
                                l = 38,
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    (a = g.parse(s.elements.preview)),
                                        (document.body.style[i] = "none"),
                                        (r =
                                            s.elements.viewport.getBoundingClientRect()),
                                        (function (e) {
                                            var n = e[0],
                                                r = e[1],
                                                l = {};
                ...
                function () {
                    ...
                    function r() {
                        (function (i) {
                            ...
                            if (
                                ...
                                n.elements.zoomer.setAttribute(
                                    "aria-valuenow",
                                    n._currentZoom
                                ),
                                s(),
                                ...
                                var l = function (e) {
                                    ...
                                    u = l.origin;
                                o.x >= h.maxX &&
                                    ((a.x = u.minX), (o.x = h.maxX)),
                                    o.x <= h.minX &&
                                        ((a.x = u.maxX), (o.x = h.minX)),
                                    o.y >= h.maxY &&
                                        ((a.y = u.minY), (o.y = h.maxY)),
                                    o.y <= h.minY &&
                                        ((a.y = u.maxY), (o.y = h.minY));
                            }
                            s(), M.call(n), z.call(n);
                        }).call(i, {
                    ...
                    p(n, "cr-slider-wrap"),
                        ...
                        i.options.mouseWheelZoom &&
                            (i.elements.boundary.addEventListener(
                                "mousewheel",
                                a
                            ),
                            i.elements.boundary.addEventListener(
                    ...
                    function m(a) {
                        if (
                            ...
                            if (
                                ...
                                (e =
                                    -1 !==
                                    a.currentTarget.className.indexOf(
                                        "vertical"
                                    )
                                        ? "v"
                                        : "h"),
        ...
        F.call(this) &&
            ...
            this.data.points.length
                ? function (i) {
                      if (4 !== i.length)
                          throw (
                              "Croppie - Invalid number of points supplied: " +
                              i
                          );
                      var n = i[2] - i[0],
                        ...
                        function (e) {
                            ...
                            t
                                ...
                                b(
                                    t,
                                    i,
                                    (this.options.enableOrientation && e) ||
                                        y(i)
                                );
            ...
            "viewport" === r
                ...
                : "object" == typeof r &&
                  (r.width && r.height
                      ...
                      : r.width
                      ? ((i.outputWidth = r.width),
                        (i.outputHeight = r.width / f))
                      : r.height &&
                        ((i.outputWidth = r.height * f),
            ...
            new Promise(function (e) {
                switch (o.toLowerCase()) {
                    ...
                    case "base64":
                        e(
                            function (e) {
                                return Y.call(this, e).toDataURL(
                                    e.format,
                                    e.quality
                                );
                            }.call(t, i)

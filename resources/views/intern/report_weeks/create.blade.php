            ...
            <div class="section-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-12 col-md-6 col-lg-6">
                        <form action="{{ route('report-weeks.store') }}" method="POST" enctype="multipart/form-data">
                            <div class="card">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-12">
                                            <textarea name="deskripsi" id="deskripsi" class="summernote-simple" required>{{ old('deskripsi') }}</textarea>
                                        </div>
                                        @error('deskripsi')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="file" name="foto" id="foto"
                                            class="form-input @error('username') is-invalid @enderror" accept="image/*" required>
                                        @error('foto')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
